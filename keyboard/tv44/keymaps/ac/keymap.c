...
[_QWERTY] = { /* Qwerty */
  ...
  {KC_LCTL,    KC_LGUI,    KC_LALT,    FUNC(10),    XXXXXXX,  XXXXXXX, XXXXXXX,  FUNC(11),   KC_RALT,    KC_APP,     XXXXXXX,    KC_RCTL}
},
...
[_TB] = { /* Tab */
  ...
  {KC_TRNS,    F(1),       F(2),       F(3),        F(4),     F(5),    F(6),     F(7),       F(8),       KC_UP,      KC_TRNS,    KC_ENT},
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [10]  = ACTION_LAYER_TAP_KEY(_RAISE, KC_SPC),
  [11]  = ACTION_LAYER_TAP_KEY(_LOWER, KC_SPC),
};
